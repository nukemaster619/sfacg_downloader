...
SIGNATURE_BOOTSTRAP_CHAPTER = '8436696'
IMAGE_WORKERS = 6
CACHE_DIR = "cache"
...
CHAR_MAP = {source: target for source, target in zip(SPECIAL_CHARS, REPLACEMENT_CHARS)}
STRINGS = {'zh': {'select_lang': '请选择界面语言 / Please select your language', 'lang_menu': '1. 中文\n2. English', 'lang_prompt': '输入选项 (默认 1): ', 'invalid_lang': '无效选项，已默认使用中文。', 'bootstrapping': '正在初始化请求签名...', 'bootstrapped': '初始化完成。', 'cookie_created': 'cookie.txt 已创建', 'cookie_read': '已读取本地 cookie。', 'input_phone': '输入手机号: ', 'input_password': '输入密码: ', 'login_failed': '登录失败，请检查手机号或密码。', 'input_novel_id': '输入小说ID: ', 'title_fetch_failed': '获取标题失败', 'catalog_fetch_failed': '获取目录失败', 'cover_fetch_failed': '封面下载失败，将继续生成无封面的 EPUB。', 'novel_title': '小说标题', 'downloading_volume': '正在下载分卷:', 'downloaded': '已下载', 'chapter_locked': '下载失败，请确认该章节已经购买或解锁', 'chapter_network_fail': '下载失败，可能是网络问题', 'image_downloaded': '图片已下载', 'plan_download': '准备下载:', 'volume_prompt': '请输入要下载的卷号(如 1,3-5，不输入则下载全部): ', 'chapter_prompt': '请输入该卷要下载的章节序号(如 1,3-5，不输入则下载整卷): ', 'chapter_error': '章节序号输入有误，请重新输入', 'choose_chapter': '可下载章节如下：', 'volume_error': '卷号输入有误，请重新输入', 'saved': '已保存 TXT 和 EPUB:', 'fatal': '程序发生错误:', 'retrying': '请求返回 417，正在重新签名后重试...', 'catalog_empty': '没有获取到目录，或者目录为空。', 'choose_volume': '可下载分卷如下：', 'checking_login': '正在检查登录状态...', 'login_ok': '登录成功。', 'logging_in': '正在登录...', 'fetching_catalog': '正在获取书籍信息和目录...', 'fetching_cover': '正在下载封面...', 'image_embed_failed': '插图嵌入失败', 'saving_cookie': '正在保存 cookie...', 'loading_cookie': '正在读取本地 cookie...', 'skipping_volume': '跳过分卷:', 'volume_done': '分卷处理完成:', 'chapters_done': '章节处理完成，共成功下载', 'empty_selection': '没有选中任何有效分卷', 'using_saved_cookie': '尝试使用本地 cookie 登录...', 'missing_content': '章节没有返回正文内容', 'cover_done': '封面下载完成', 'book_building': '正在生成电子书...', 'book_writing': '正在写入文件...'}, 'en': {'select_lang': '请选择界面语言 / Please select your language', 'lang_menu': '1. 中文\n2. English', 'lang_prompt': 'Choose option (default 1): ', 'invalid_lang': 'Invalid option. Defaulting to Chinese.', 'bootstrapping': 'Preparing request signature...', 'bootstrapped': 'Initialization complete.', 'cookie_created': 'cookie.txt created', 'cookie_read': 'Loaded saved cookie.', 'input_phone': 'Enter phone number: ', 'input_password': 'Enter password: ', 'login_failed': 'Login failed. Please check the phone number or password.', 'input_novel_id': 'Enter novel ID: ', 'title_fetch_failed': 'Failed to fetch title', 'catalog_fetch_failed': 'Failed to fetch catalog', 'cover_fetch_failed': 'Cover download failed. EPUB will be created without a cover.', 'novel_title': 'Novel title', 'downloading_volume': 'Downloading volume:', 'downloaded': 'downloaded', 'chapter_locked': 'download failed, make sure this chapter has been purchased or unlocked', 'chapter_network_fail': 'download failed, possibly due to network issues', 'image_downloaded': 'image downloaded', 'plan_download': 'Selected download plan:', 'volume_prompt': 'Enter volume numbers to download (e.g. 1,3-5; blank = all): ', 'chapter_prompt': 'Enter chapter numbers for this volume (e.g. 1,3-5; blank = whole volume): ', 'chapter_error': 'Invalid chapter selection, please try again', 'choose_chapter': 'Available chapters:', 'volume_error': 'Invalid volume selection, please try again', 'saved': 'Saved TXT and EPUB:', 'fatal': 'Program error:', 'retrying': 'Request returned 417, refreshing signature and retrying...', 'catalog_empty': 'No catalog was returned, or the catalog is empty.', 'choose_volume': 'Available volumes:', 'checking_login': 'Checking login state...', 'login_ok': 'Login successful.', 'logging_in': 'Signing in...', 'fetching_catalog': 'Fetching novel details and catalog...', 'fetching_cover': 'Downloading cover...', 'image_embed_failed': 'Image embed failed', 'saving_cookie': 'Saving cookie...', 'loading_cookie': 'Reading local cookie...', 'skipping_volume': 'Skipping volume:', 'volume_done': 'Finished volume:', 'chapters_done': 'Finished chapter batch, downloaded', 'empty_selection': 'No valid volume was selected', 'using_saved_cookie': 'Trying saved cookie first...', 'missing_content': 'No chapter body was returned', 'cover_done': 'Cover downloaded', 'book_building': 'Building ebook...', 'book_writing': 'Writing output files...'}}

STRINGS["zh"].update({
    "lang_prompt": "输入选项 / Choose option (默认/default 1): ",
    "cache_loaded": "[缓存] 从 {path} 加载了 {count} 个章节",
    "cache_load_failed": "[缓存] 加载失败: {error}",
    "cache_saved": "[缓存] 保存了 {count} 个章节到 {path}",
    "cache_save_failed": "[缓存] 保存失败: {error}",
    "cache_hit": "[缓存] {title} 从缓存加载",
    "downloaded_cached": "{title} 已下载并缓存",
    "download_failed_uncached": "[{title}] 下载失败，未缓存",
    "locked_placeholder": "【未订阅/需付费】\n\n",
    "chapter_failed_placeholder": "【章节下载失败，ID: {chapter_id}】\n\n",
    "chapter_placeholder_added": "[警告] 章节 {title} 下载失败，已添加占位符",
    "retrying_417": "请求返回 417，正在重新签名后重试 ({attempt}/{retries})...",
    "retrying_417_suppressed": "请求返回 417，正在重新签名后重试；相同提示已限流...",
    "retrying_417_exhausted": "请求连续返回 417，已用尽 {retries} 次重试。",
    "request_json_invalid": "响应不是有效 JSON",
    "binary_failed": "二进制下载失败",
    "failed_placeholders": "{count} 个失败占位符",
})

STRINGS["en"].update({
    "lang_prompt": "输入选项 / Choose option (default 1): ",
    "cache_loaded": "[Cache] Loaded {count} chapters from {path}",
    "cache_load_failed": "[Cache] Failed to load cache: {error}",
    "cache_saved": "[Cache] Saved {count} chapters to {path}",
    "cache_save_failed": "[Cache] Failed to save cache: {error}",
    "cache_hit": "[Cache] {title} loaded from cache",
    "downloaded_cached": "{title} downloaded and cached",
    "download_failed_uncached": "[{title}] Download failed; not cached",
    "locked_placeholder": "[Locked / paid chapter]\n\n",
    "chapter_failed_placeholder": "[Chapter download failed, ID: {chapter_id}]\n\n",
    "chapter_placeholder_added": "[Warning] Chapter {title} failed to download; placeholder added",
    "retrying_417": "Request returned 417; refreshing signature and retrying ({attempt}/{retries})...",
    "retrying_417_suppressed": "Request returned 417; refreshing signature and retrying. Similar messages are being throttled...",
    "retrying_417_exhausted": "Request kept returning 417 after {retries} retries.",
    "request_json_invalid": "Response was not valid JSON",
    "binary_failed": "Binary download failed",
    "failed_placeholders": "{count} failed placeholders",
})
...
def set_language(language: str) -> None:
    ...
    CURRENT_LANGUAGE = language if language in STRINGS else "zh"

def tr(key: str) -> str:
    return STRINGS.get(CURRENT_LANGUAGE, STRINGS["zh"]).get(key, STRINGS["zh"].get(key, key))

def replace_chars(text: str, char_map: dict[str, str] | None = None) -> str:
    mapping = CHAR_MAP if char_map is None else char_map
